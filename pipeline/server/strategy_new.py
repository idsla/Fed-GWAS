...
class FederatedGWASStrategy(Strategy):
    def __init__(
        ...
        **kwargs
        ...
        self.current_server_round = 0        # tracking server round
    ...
    def initialize_parameters(
        ...
        For federated GWAS, we don't have traditional model parameters.
        Instead, we initialize with empty parameters.
        """
        return None
    ...
    def configure_fit(
        ...
        # Create configuration based on current stage
        config = self._get_stage_config(server_round)
        
        # Create fit instructions based on stage
        if parameters is None:
            # No parameters to send for most stages
    ...
    def aggregate_fit(
        ...
        ################################################################################
            ...
            return ndarrays_to_parameters([global_seed_np]), {}
        ...
        # Default return for unknown stages
        return None, {}
    ...
    def configure_evaluate(
        ...
        For federated GWAS, we don't have traditional model evaluation.
        This returns an empty list as evaluation is not applicable.
        """
        return []
    ...
    def aggregate_evaluate(
        ...
        For federated GWAS, we don't have traditional model evaluation metrics.
        This returns None for loss and empty metrics.
        """
        self.current_server_round = server_round
        return None, {}
    ...
    def evaluate(
        ...
        For federated GWAS, server-side evaluation is not applicable.
        This returns None.
        """
        self.current_server_round = server_round
        return None
    ...
    def _print_server_status(self):
        ...
        print(f"[Server] Server-status current_stage={self.current_stage} server_round={self.current_server_round}")
