...
class BaselineGenerator:
    ...
    def run_qc(self, input_prefix: str) -> None:
        ...
        counts = compute_genotype_counts(qc_input_prefix, "baseline", log_dir=str(self.output_dir))
        missing = compute_missingness_counts(qc_input_prefix, "baseline", log_dir=str(self.output_dir))
